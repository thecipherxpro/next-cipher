  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <ServicePageTemplate
        ...
        includedItems={[
          { title: "Help Desk & Remote Support", description: "Get fast answers and remote fixes for everyday IT issues." },
          { title: "Hardware Setup & Repairs", description: "Computers, printers, servers, and equipment handled." },
          { title: "Network Setup & Maintenance", description: "Reliable WiFi, wired networks, and connectivity." },
          { title: "Software Installation & Licensing", description: "Keep your software updated, licensed, and working." },
          { title: "Data Backup & Recovery", description: "Protect your business data with automated backups." },
          { title: "Vendor Coordination", description: "We handle your tech vendors so you don't have to." },
        ]}
        whoItsFor={[
          "Small offices",
          "Medical clinics",
