...
const topBadges = ["Small Business Focused", "Free Consultation", "Custom Solutions", "Local Service"]
    ...
    <section id="faq" className="py-16 sm:py-20 md:py-24 lg:py-32 bg-card">
      <div className="w-full container-full-wide">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-5 sm:mb-6 max-w-xl mx-auto">
